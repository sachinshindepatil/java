...
public class ForgotServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   int rs=ps.executeUpdate("Update login set password='"+password+"' where username='"+name+"' ");
		if(rs!=0)
		{
			out.println("<html><body><center>Password Sucessfully Updated...</center></body></html>");
			request.getRequestDispatcher("Forgot.jsp").include(request, response);
		}
		else 
		{
